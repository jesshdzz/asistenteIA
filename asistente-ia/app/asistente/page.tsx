...
export default function Home() {
  ...
  const iniciarGrabacion = async () => {
    ...
    mediaRecorder.onstop = async () => {
      ...
      const textoParaHablar = detectarYEjecutarAccion(data.transcripcion);
  ...
  return (
    <main className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-6">
      ...
      <button
        className={`mb-4 px-4 py-2 rounded-lg text-white font-bold shadow-lg transition-all duration-200 ${
          grabando ? "bg-red-500" : "bg-green-500"
        }`}
